    ...
    <div>
      <div>
        ...
        <section style={{padding: '50px 0'}}>
          ...
          <p className={classes.centerx} style={{paddingBottom: 50}}>For programming competitions, I use devpost.com.  There are competitions of all sorts you can join and compete in.  This really teaches you how to manage your time well, work with your teammates, and put everything you have learned into real life projects.</p>
        </section>

    ...
    <div>
      <div>
        ...
        <section style={{background: 'var(--b-dim)', padding: '100px 0'}}>
          <Skill icon="https://replit.com/public/images/languages/react.svg" text="Over fourty percent of all websites on the internet use react.  It is the backbone of almost all websites.  I cannot live without it." lang="React"/>
          <Skill icon="/icons/next-js.svg" text="Websites like TikTok, Twitch, AT&T, and many more are made with this extremely powerful and amazing framework.  This is also another thing that I can't make websites without." dark={true} lang="Next.js"/>
          <Skill icon="https://replit.com/public/images/languages/web_project.svg" text="Every website on the internet is build with HTML5.  I'm glad I know how to use this!" lang="HTML5"/>
          <Skill icon="https://i.ibb.co/MCz3w6F/css.png" text="Background Colors, fancy fonts, and (almost) all things stylish on the web are originated from css." lang="CSS3"/>
          ...
          <Skill icon="https://replit.com/public/images/languages/nodejs.svg" text="NodeJS, my friends, is what I use to make your sites awesome.  Accounts & Logins, user posting, you name it!" lang="NodeJS"/>
          ...
          <Skill icon="https://replit.com/cdn-cgi/image/width=2048,quality=80/https://storage.googleapis.com/replit/images/1638396182851_ab511d3ca9a79d5a9cb9a2b620c24841.png" text="I've built a few sites out of Flask, which is for running web servers and keeping them online.   The unfortunate thing is that it's made with python and is extremely expensive to keep online and running well." dark={true} lang="Flask"/>
          <Skill icon="https://www.vectorlogo.zone/logos/jquery/jquery-icon.svg" text="Jquery is helpful when it comes to interactive things in your website.  The bad part?  It performs slowly and takes up a whole bunch of memory and storage according to todays' modern standards." lang="Jquery"/>
          <Skill icon="https://replit.com/cdn-cgi/image/width=2048,quality=80/https://storage.googleapis.com/replit/images/1637786528594_06a7f6e40c28ff5d1346ad3f25aed1b5.png" text="Not really a programming language, but Markdown comes in useful when writing documentations and posts." lang="Markdown"/>
        </section>
        <Footer />
      </div>

...
const fts = [
  ...
  ["email subscribe form", 40, 2],
  ["custom-style emails", 25, 3],
  ["email sending (other)", 25, 4],
  ["contact form", 5, 1],

  "art & graphics",
  ["logo design", 5, 1],
  ["custom vector graphics", 20, 6],
  ["custom vector icons", 10, 2],
  ...
  ["sound effects", 10, 2],
  ["fade animations", 10, 3],

  "animations",
  ["animated background(s)", 10, 2],
  ["video background(s)", 5, 1],

  "miscalleneous",
  ["administration dashboard", 75, 5],
  ["toggleable dark mode", 25, 2],
  ["\"I'm not a robot\" captchas", 15, 2],
  ["image uploading", 25, 2],
  ["realtime updates / multiplayer", 50, 5],
  ["user posting/commenting abilities", 25, 4],
  ["feed/hotlist functionality", 50, 4],
  ["interval (cron) timers", 15, 1],
  ["downloadable file(s)", 20, 1],
];
